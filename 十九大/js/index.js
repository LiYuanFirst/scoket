...
var typeList1 = [
	{
		id:'001',
		type:'01',
		question:'十九大报告中提出，中国秉持（ ）的全球治理观，倡导国际关系民主化，坚持国家不分大小、强弱、贫富一律平等（单选）',
		options:['A、亲诚惠容理念 ','B、共商共建共享  ','C、正确义利观'],
		key:[1]
	},{
		id:'002',
		type:'01',
		question:'《党章》规定，党员的党龄，从( )之日算起。（单选）',
		options:['A、递交入党申请书','B、递交入党志愿书 ','C、支部大会通过其为预备党员','D、预备期满转为正式党员'],
		key:[3]
	},{
		id:'003',
		type:'01',
		question:'十九大报告指出，建设______是中华民族伟大复兴的基础工程（单选）',
		options:['A、经济强国 ','B、政治强国  ',' C、教育强国 ','D、文化强国'],
		key:[2]
	},{
		id:'004',
		type:'01',
		question:'十九大报告指出，我国经济已由______阶段转向______阶段，正处在转变发展方式、优化经济结构、转换增长动力的攻关期，建设现代化经济体系是跨越关口的迫切要求和我国发展的战略目标。（单选）',
		options:['A、高速增长 高水平发展 ','B、高速发展 高水平发展','C、高速增长 高质量发展','D、高速发展 高质量发展'],
		key:[2]
	},{
		id:'005',
		type:'02',
		question:'十九大报告指出，科学立法、严格执法、公正司法、全民守法深入推进，______建设相互促进，中国特色社会主义法治体系日益完善，全社会法治观念明显增强。（多选）',
		options:['A、法治生活','B、法治国家 ','C、法治政府','D、法治社会'],
		key:[1,2,3]
	},{
		id:'006',
		type:'02',
		question:'十九大报告指出，出台中央八项规定，严厉整治_____，坚决反对特权。（多选）',
		options:['A、形式主义','B、官僚主义  ','C、享乐主义','D、奢靡之风','E、个人主义'],
		key:[0,1,2,3]
	},{
		id:'007',
		question:'十九大报告指出，这个新时代，是____。（多选）',
